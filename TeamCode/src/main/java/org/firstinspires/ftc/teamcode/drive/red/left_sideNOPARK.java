...
@Autonomous(group = "drive", name = "left_sideNOPARK")
public class left_sideNOPARK extends LinearOpMode {
    ...
    double zoo = 0d;
    double startTime = 0d;
    Pose2d broo = new Pose2d(50.0, 47.5, Math.toRadians(45));
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory foo1 = drive.trajectoryBuilder(startPose)
                .splineToSplineHeading(broo, Math.toRadians(0))
                .addTemporalMarker(0, () -> {
                    lift_the_lift(true);
                })
                .build();
