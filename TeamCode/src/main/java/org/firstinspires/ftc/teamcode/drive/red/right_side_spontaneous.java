...
@Autonomous(group = "drive", name = "right_side_spontaneous")
public class right_side_spontaneous extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory scorePoint = drive.trajectoryBuilder(startPose)
                .splineToLinearHeading(artemis, Math.toRadians(0),
                        SampleMecanumDrive.getVelocityConstraint(DriveConstants.MAX_VEL * 1.15, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL * 1.13))
                .addTemporalMarker(0, () -> {
                    lift_the_lift(true);
                })
                .build();
