...
@Autonomous(group = "drive", name = "left_sideEXP")
public class left_sideEXPERIMENTAL extends LinearOpMode {
    ...
    private void drop_the_lift(boolean slightly)
    {
        ...
        else
        {
            ...
            armMotor.setTargetPosition(-214);
        }
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory foo1 = drive.trajectoryBuilder(startPose)
                .splineToSplineHeading(new Pose2d(49.5, 47.0, Math.toRadians(45)), Math.toRadians(0),
                        SampleMecanumDrive.getVelocityConstraint(55.5, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
        ...
        Trajectory foo4 = drive.trajectoryBuilder(foo3.end())
                .splineToSplineHeading(new Pose2d(48.75, 21.5, Math.toRadians(0)), Math.toRadians(0),
                        SampleMecanumDrive.getVelocityConstraint(55.5, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .addTemporalMarker(1, () -> {
                    zero_motors();
        ...
        Trajectory other_parking = drive.trajectoryBuilder(foo5.end())
                .splineToSplineHeading(new Pose2d(-54, 54, Math.toRadians(0)), Math.toRadians(0),
                        SampleMecanumDrive.getVelocityConstraint(42.5, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
